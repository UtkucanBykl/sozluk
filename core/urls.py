...
urlpatterns = [
    ...
    path('titles/<int:title_id>/entries/', EntryListCreateAPIView.as_view(), name='entry-list-create'),
    path('titles/<int:title_id>/entries/<int:id>/', EntryRetrieveUpdateDestroyAPIView.as_view(), name='entry-retrieve-update-delete'),
